...
namespace UnityEditor.UI
{
	...
	static internal class ExtensionMenuOptions
	{
		...
		private static UnityEngine.Color s_DefaultSelectableColor = new UnityEngine.Color(1f, 1f, 1f, 1f);
		private static UnityEngine.Color s_TextColor = new UnityEngine.Color(50f / 255f, 50f / 255f, 50f / 255f, 1f);
		#endregion
		...
		private static void SetDefaultColorTransitionValues(Selectable slider)
		{
			...
			colors.highlightedColor = new UnityEngine.Color(0.882f, 0.882f, 0.882f);
			colors.pressedColor = new UnityEngine.Color(0.698f, 0.698f, 0.698f);
			colors.disabledColor = new UnityEngine.Color(0.521f, 0.521f, 0.521f);
		}
		...
		static public void AddHorizontalScrollSnap(MenuCommand menuCommand)
		{
			...
			text.color = new UnityEngine.Color(0.196f, 0.196f, 0.196f);
		...
		static public void AddContentScrollSnapHorizontal(MenuCommand menuCommand)
		{
			...
			image.sprite = null;
			image.color = new UnityEngine.Color(1, 0, 0, .5f);
			...
			contentImage.color = new UnityEngine.Color(0, 0, 1, .5f);
			...
			childPage01Image.color = UnityEngine.Color.white;
			...
			childPage02Image.color = UnityEngine.Color.white;
			...
			childPage03Image.color = UnityEngine.Color.white;
			...
			childPage04Image.color = UnityEngine.Color.white;
			...
			childPage05Image.color = UnityEngine.Color.white;
		...
		static public void AddAutoCompleteComboBox(MenuCommand menuCommand)
		{
			...
			overlay.AddComponent<Image>().color = new UnityEngine.Color(0.243f, 0.871f, 0f, 0f);
		...
		static public void AddDropDownList(MenuCommand menuCommand)
		{
			...
			itemTemplateImage.GetComponent<Image>().color = new UnityEngine.Color(0, 0, 0, 0);
			...
			mainButtonImageRT.GetComponent<Image>().color = new UnityEngine.Color(1, 1, 1, 0);
		...
		static public void AddSelectionBox(MenuCommand menuCommand)
		{
			...
			selectableArea.color = new UnityEngine.Color(0.816f, 0.816f, 0.816f, 0.353f);
		...
		static public void AddReorderableScrollRectVertical(MenuCommand menuCommand)
		{
			...
			Element01Image.color = UnityEngine.Color.green;
			...
			Element02Image.color = UnityEngine.Color.red;
			...
			Element03Image.color = UnityEngine.Color.blue;
		...
		static public void AddSegmentedControl(MenuCommand menuCommand)
		{
			...
			UnityEngine.Color selectedColor = new UnityEngine.Color(0f, 0.455f, 0.894f);
		...
		static public void AddBoxSlider(MenuCommand menuCommand)
		{
			...
			backgroundImage.color = new UnityEngine.Color(1f, 1f, 1f, 0.392f);
			...
			handleImage.color = new UnityEngine.Color(1f, 1f, 1f, 0.392f);
		...
		static public void AddRadialSlider(MenuCommand menuCommand)
		{
			...
			slidrImage.color = UnityEngine.Color.red;
			slidrImage.fillAmount = 0;
			RadialSlider slider = SliderControl.AddComponent<RadialSlider>();
			slider.StartColor = UnityEngine.Color.green;
			slider.EndColor = UnityEngine.Color.red;
		...
		private static GameObject AddInputFieldAsChild(GameObject parent)
		{
			...
			UnityEngine.Color placeholderColor = text.color;
