...
/// </summary>
public class Table_Abocado
{
    /* Field & Property */
    public string abocadoID;
    ...
    public Table_Abocado(string abocadoID, EnumData.Abocado level, int quality, int quality_max, int harvest, int harvestPlus)
    {
        this.abocadoID = abocadoID;
        this.level = level;
